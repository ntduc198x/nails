...
const TELEGRAM_STATE_DIR = process.env.TELEGRAM_STATE_DIR || "/tmp/openclaw-telegram-state";
const TELEGRAM_CONVERSATION_FALLBACK_FILE = path.join(TELEGRAM_STATE_DIR, "telegram-conversations.json");
const TELEGRAM_REPLY_PANEL_FALLBACK_FILE = path.join(TELEGRAM_STATE_DIR, "telegram-reply-panels.json");
